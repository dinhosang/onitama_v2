...
public class ConcurrentByEachCardStaticCardFactory implements ICreate {
...
/*      above same as below - above is lambda version, below is method reference version
        ...
        for(Integer number : randomNumbersListToCreateCardsBy){
            ...
            class concurrentSingleCardCreation implements Runnable {
                ...
                private concurrentSingleCardCreation(IContain deck, Integer number, ReentrantLock lock) {
                    this.deck   = deck;
                    this.number = number;
                }
            ...
            concurrentSingleCardCreation cardCreator = new concurrentSingleCardCreation(deck, number, lock);
